...
const Publish = ({ initialDeta }: PublishProps) => {
  ...
  const url = `${origin}/preview/${initialDeta._id}`;

  const onPublish = () => {
    setIsSubmiting(true);

    if (initialDeta._id === undefined) {
      ...
      <PopoverContent className="w-72" align="end" alignOffset={8} forceMount>
        {initialDeta.isPublished ? (
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-sm font-medium mb-2">Publish the Note</p>
